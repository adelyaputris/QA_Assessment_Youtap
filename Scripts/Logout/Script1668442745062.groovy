...
WebUI.click(findTestObject('Login/Akun'))

WebUI.click(findTestObject('Login/Logout'))

//def text = WebUI.getText(findTestObject('Login/Button Login'))
//System.out.println(text)
//WebUI.verifyMatch(text, '^Selamat datang di*', true, FailureHandling.STOP_ON_FAILURE)


WebUI.verifyTextPresent('Selamat datang di Portal Usaha Youtap', false)
